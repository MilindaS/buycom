...
$sql = mysqli_query($link,"SELECT id FROM transactions WHERE txn_id='$this_txn' LIMIT 1");
...
foreach ($id_str_array as $key => $value) {
	...
	$sql = mysqli_query($link,"SELECT price FROM products WHERE id='$product_id' LIMIT 1");
...
$sql = mysqli_query($link,"INSERT INTO transactions (product_id_array, payer_email, first_name, last_name, payment_date, mc_gross, payment_currency, txn_id, receiver_email, payment_type, payment_status, txn_type, payer_status, address_street, address_city, address_state, address_zip, address_country, address_status, notify_version, verify_sign, payer_id, mc_currency, mc_fee) 
